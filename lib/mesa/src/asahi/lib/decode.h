...
void agxdecode_drm_cmd_render(struct drm_asahi_cmd_render *cmdbuf, bool verbose);

void agxdecode_drm_cmd_compute(struct drm_asahi_cmd_compute *cmdbuf, bool verbose);
